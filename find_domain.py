...
valid_domain3 = ['time.com','abcnews.go.com','investopedia.com','tumblr.com','dailykos.com','wired.com','stlmag.com','edition.cnn.com',\
...
valid_domain_final = valid_domain + valid_domain3

urls_list = []
writefile = file('data/17/news_17_whole.csv', 'w')
