...
# m = 0
# text_file = open("../data/temporary/no_train.txt", "w")
# for i in no_train:
#     m += 1
...
# print m
# j = 0
# text_file = open("../data/temporary/no_test.txt", "w")
# for i in no_test:
#     j += 1
#     text_file.write(str(i)+"\n")
# text_file.close()
...
no_trains = []
i = 0
with open('../data/temporary/no_train.txt', 'rb') as infile:
    for line in infile:
        i += 1
...
#
no_tests = []
with open('../data/temporary/no_test.txt', 'rb') as infile:
    for line in infile:
        no_tests.append(int(line))
infile.close()


writefile = file('../data/output/news_gra_sen_title_test.csv', 'w')
# myfile = codecs.open('csv_train.csv', 'r', encoding='ascii', errors='ignore')
writer = csv.writer(writefile)
print "test",len(no_tests)
j = 0
for i in no_tests:
    j += 1
